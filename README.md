...
|    |  后台体验账号/密码：admin/123456   |  公众号:![输入图片说明](https://images.gitee.com/uploads/images/2020/0324/234811_5b3b0d4c_477893.jpeg "qrcode_for_gh_95df5a2881cc_258.jpg")   |
...
### VIP版
1.包括了开源版，还包括了移动端(H5+公众号)、小程序(mpvue2框架）、移动端API、uniapp(可打包微信小程序与APP，即将发布)
...
- yshop2.0发布更新如下：
- yshop2.1即将发布更新如下(预计4月发布)：
- 1、单门店升级为多门店
- 2、充值增加充值方案
- 3、打通小程序与公众号账号
- 4、新增微信app支付（主要用于uniapp
- 5、发布uniapp,uniapp目前支持打包微信小程序与APP(包括安卓Android与苹果IOS)
